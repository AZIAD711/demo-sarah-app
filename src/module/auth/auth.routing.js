...
import {loginSchema,resetPasswordSchema,signupSchema} from "./auth.valdiation.js"
...
userRouter.put("/reset/password",schemaValidate(resetPasswordSchema),resetPasswordController)
